...
final case class AsepriteFrameDelegate(_filename: String, _frame: AsepriteRectangleDelegate, _rotated: Boolean, _trimmed: Boolean, _spriteSourceSize: AsepriteRectangleDelegate, _sourceSize: AsepriteSizeDelegate, _duration: Int) {
    @JSExport
