...
object Assets {
  ...
  val images: Set[AssetType] = Set(
    ...
    ImageAsset(logoRef, "assets/pk_games_pixel.png"),
    ImageAsset(spriteSheetRef, "assets/graphics.png"),
    ImageAsset(fontRef, "assets/boxy_font.png")
  )

  val fontKey: FontKey = FontKey("boxyFont")

  val fontInfo: FontInfo =
    FontInfo(fontKey, Assets.fontRef, 320, 230, FontChar("?", 93, 52, 23, 23))
