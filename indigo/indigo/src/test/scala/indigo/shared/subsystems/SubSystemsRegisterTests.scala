...
class SubSystemsRegisterTests extends munit.FunSuite {
  ...
  test("The sub system register.should allow you to update sub systems") {
    ...
    val data = r
      .update(context(6), Batch(PointsTrackerEvent.Add(10)))
      .unsafeGet
      .stateMap
  ...
  test("The sub system register.should allow you to update sub systems and emit events") {
    ...
    val updated = r.update(context(6), Batch(PointsTrackerEvent.LoseAll))
  ...
  test("The sub system register.should allow you to render sub systems") {
    ...
    val rendered =
      r.update(context(6), Batch(PointsTrackerEvent.Add(10)))
        .unsafeGet
        .present(context(6))
        .unsafeGet
        .layers
    ...
    assert(rendered.exists(_ == "20"))
    assert(rendered.exists(_ == "60"))
  }
