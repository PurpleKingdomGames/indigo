    ...
    Outcome(
      SceneUpdateFragment.empty
        .addLayer(
          ...
          CloneBatch(CloneId("shape clone"), CloneTransformData(10, 10)),
          CloneBatch(CloneId("shape clone"), CloneTransformData(20, 10)),
          CloneBatch(CloneId("shape clone"), CloneTransformData(30, 10)),
          Shape
            .Polygon(
