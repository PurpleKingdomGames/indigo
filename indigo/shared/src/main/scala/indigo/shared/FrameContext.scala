...
/**
  ...
  * @param dice A pseudo-random number generator, made predictable / reproducible  by being seeded on the current running time.
  ...
  * @param boundaryLocator A service that can be interrogated for the calculated dimensions of screen elements.
