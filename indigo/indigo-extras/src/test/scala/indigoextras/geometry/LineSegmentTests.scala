...
class LineSegmentTests extends munit.FunSuite {
   ...
   */
      ...
      test("calculating line components") {

        test("should correctly calculate the line components") {
        ...
        test("should correctly identify a line parallel to the y-axis") {
      ...
      test("line intersections") {
        ...
        test("should not intersect with a parallel lines") {
        ...
        test("should intersect lines at right angles to each other") {
          val actual: IntersectionResult = LineSegment.intersection(
        ...
        test("should intersect diagonally right angle lines") {
          val actual: IntersectionResult = LineSegment.intersection(
        ...
        test("should intersect diagonally non-right angle lines") {
          val actual: IntersectionResult = LineSegment.intersection(
        ...
        test("should intersect where one line is parallel to the y-axis") {
          val actual: IntersectionResult = LineSegment.intersection(
        ...
        test("should intersect where one line is parallel to the x-axis") {
          val actual: IntersectionResult = LineSegment.intersection(
        ...
        test("should give the same intersection regardless of order") {
        ...
        test("should intersect diagonally right angle lines (again)") {
          val actual: IntersectionResult = LineSegment.intersection(
      ...
      test("normals") {
        test("should calculate the normal for a horizontal line (Left -> Right)") {
        ...
        test("should calculate the normal for a horizontal line (Right -> Left)") {
        ...
        test("should calculate the normal for a vertical line (Top -> Bottom") {
        ...
        test("should calculate the normal for a vertical line (Bottom -> Top") {
          val start: Vertex = Vertex(1, -10)
          val end: Vertex   = Vertex(1, 10)
        ...
        test("should calculate the normal for a diagonal line") {
      ...
      test("Normalising a point") {

        test("should be able to normalise a point") {
      ...
      test("Vertexs & Lines") {
        ...
        test("Vertex on a line") {
          ...
          test("should be able to check if a point is NOT on a line") {
            val line: LineSegment = LineSegment((10d, 10d), (20d, 20d))
