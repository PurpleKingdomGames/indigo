...
final class ProcessedSceneData(
    ...
    val gameLayerDisplayObjects: List[DisplayEntity],
    val lightingLayerDisplayObjects: List[DisplayEntity],
    val distortionLayerDisplayObjects: List[DisplayEntity],
    val uiLayerDisplayObjects: List[DisplayEntity],
