...
class DisplayObjectConversionsTests extends munit.FunSuite {
  ...
  val graphic: Graphic =
    Graphic(Rectangle(10, 20, 200, 100), 2, StandardMaterial.Basic(AssetName("texture")))
  ...
  test("create a CheapMatrix4 from a SceneGraphNode.translation") {
    ...
    val node: SceneGraphNode =
      Graphic(100, 100, StandardMaterial.Basic(AssetName("test")))
        .moveTo(10, 20)
  ...
  test("create a CheapMatrix4 from a SceneGraphNode.translation with flip") {
    ...
    val node: SceneGraphNode =
      Graphic(width, height, StandardMaterial.Basic(AssetName("test")))
        .moveTo(10, 20)
        .flipHorizontal(true)
        .flipVertical(true)
