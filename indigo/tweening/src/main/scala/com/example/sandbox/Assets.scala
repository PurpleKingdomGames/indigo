...
object Assets {
  ...
  object Dots {
    ...
    val dots: Graphic =
      Graphic(0, 0, 32, 32, 1, dotsMaterial)

    val red: Graphic =
      Graphic(0, 0, 16, 16, 1, dotsMaterial).withCrop(0, 0, 16, 16)

    val green: Graphic =
      Graphic(0, 0, 16, 16, 1, dotsMaterial).withCrop(16, 0, 16, 16)

    val blue: Graphic =
      Graphic(0, 0, 16, 16, 1, dotsMaterial).withCrop(0, 16, 16, 16)

    val yellow: Graphic =
      Graphic(0, 0, 16, 16, 1, dotsMaterial).withCrop(16, 16, 16, 16)
  }
